  ...
  return (
    <>
      <div
        ...
        `}
      ><Loading /></div>
      <Route path='/'><Entrance updateOriginItem={file => {
      ...
      <Route path='/spec'><SpecficationPage resource={resource} result={goal} setResult={setGoal} detail={detail} setDetail={setDetail} sendRequest={() => {
        setSpinnerState(true)
      ...
      <Route path='/reco'><RecommendPage recos={recos} /></Route>
    </>
  )
}
